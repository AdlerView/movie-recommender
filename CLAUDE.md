...
| `store/` | Partial | Pipeline inputs/outputs (large files gitignored, small files tracked) |
...
3. Pipeline input/output (curated data, model files) → `store/`
4. ML evaluation result (CSV, PNG, plots) → `evaluation/`
