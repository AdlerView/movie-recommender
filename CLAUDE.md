...
│   ├── tmdb.sqlite                             # Offline TMDB database (8.2 GB, 1.17M movies, 30 tables)
│   ├── exports/                            # TMDB daily ID exports (source for tmdb.sqlite)
│   ├── user.sqlite                           # App runtime SQLite (user ratings, watchlist, dismissed)
