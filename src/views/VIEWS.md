...
**Shared detail renderers** in `src/components.py`:
...
**Poster grid CSS:** `inject_poster_grid_css(container_key)` from `src/components.py` — invisible button overlay on poster images for click interaction. Used by Discover, Rate, Watchlist.
