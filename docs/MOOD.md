...
File: `store/tmdb-keyword-frequencies_labeled_top5000.tsv`
...
All 5000 keywords were reviewed against 3 real film overviews per keyword. The review produced **~666 corrections** across 5000 keywords (~13.3% correction rate). Review context file (temporary, not in repo) contained movie overviews for validation.
...
- **Labeled data:** `store/tmdb-keyword-frequencies_labeled_top5000.tsv`
