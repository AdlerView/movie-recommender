...
**Files:** `src/tmdb.py` (API client), `src/db.py` (SQLite layer), `src/scoring/loader.py` (array loading)
...
**Files:** `src/ml/features.py`, `src/ml/classifier.py`, `src/ml/moods.py`, `src/ml/quality.py`, `src/scoring/rank.py`, `src/scoring/loader.py`, `src/scoring/profile.py`, `src/scoring/cache.py`, `src/scoring/mood.py`, `evaluation.ipynb`
